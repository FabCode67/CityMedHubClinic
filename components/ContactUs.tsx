    ...
    <section id='contact' className="bg-gray-50 md:py-16 py-8">
      <div className="container mx-auto px-4 max-w-6xl">
        <div className="grid md:grid-cols-2 gap-12">
          ...
          <div className="bg-white relative  rounded-xl md:p-8 p-2">
            ...
            <div className="space-x-4 hidden absolute bottom-16 md:block">
                <Button
                  onClick={() => setModalOpen(true)}
                  className="text-white border-medblue   bg-blue-800 hover:bg-blue-700 rounded-full">BOOK APPOINTMENT</Button>
              </div>
          </div>
        </div>

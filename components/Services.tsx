...
const ServicesPage = () => {
  const services = [
    {
      icon: <Baby className="w-12 h-12 text-green-700" />,
      title: "Pediatrics",
    ...
    {
      icon: <Stethoscope className="w-12 h-12 text-green-700" />,
      title: "General Medicine",
      description: "Comprehensive medical care for patients of all ages."
    },
    {
      icon: <FaTooth className="w-12 h-12 text-green-700" />,
      title: "Dentistry",
      description: "Complete dental care and oral health services."
    },
    {
      icon: <Microscope className="w-12 h-12 text-green-700" />,
